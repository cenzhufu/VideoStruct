...
import StructuralItemFaceWithTip from 'stsrc/components/structural-item/face-with-tip';
import {
...
function noop() {}
class StructuralItemFaceInteractive extends STComponent<PropsType, StateType> {
	static defaultProps = {
		structuralItemInfo: {},
	...
	render() {
		...
		return (
			<StructuralItemFaceWithTip
				className={ModuleStyle['face-container']}
