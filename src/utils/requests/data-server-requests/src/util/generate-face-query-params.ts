...
import { generateFaceAttributeConditions } from './generate-attribute-query-condition';
import { mergetQueryConditionParams } from './merge-query-conditions';

export function generateFaceQueyParams(
	...
	let attributesConditions: IBDataQueryConditions = generateFaceAttributeConditions(
