...
import { generateBodyAttributeConditions } from './generate-attribute-query-condition';
import { mergetQueryConditionParams } from './merge-query-conditions';

export function generateBodyQueyParams(
	sourceIds: string[],
	...
	let attributesConditions: IBDataQueryConditions = generateBodyAttributeConditions(
