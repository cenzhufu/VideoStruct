...
import VehicleResultPresentationPanel from '../submodules/vehicle-results-presentation-panel';
...
class VehicleResultPanel extends STComponent<PropsType, StateType> {
	static defaultProps = {
		startDate: '',
		endDate: '',
		searchTargetList: [],
	...
	render() {
		return (
			<BaseResultPanel
				...
				searchTargetTypes={[ETargetType.Face, ETargetType.Vehicle]}
				...
				render={(
					...
					return (
						<VehicleResultPresentationPanel
	...
	updateStatisticsInfos = (
		...
		this.props[SearchResultPageActionsCreator.updateStatisticsInfos](
			statisticsInfos
		);
	};
	/************************************** redux方法 end*************************************/
